...
class GetList(Resource):
    def get(self):
        res = [{
            ...
            "href": "/",
            "updatedAt": 1569046270347,
            "createdAt": 1569046270347,
            "type": "CI / CD",
            "count": 43,
            ...
            "href": "/",
            "updatedAt": 1569039070347,
            "createdAt": 1569039070347,
            "type": "k8s",
            "count": 101,
            "description": "在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。",
            "activeUser": 164682,
            ...
            "href": "/",
            "updatedAt": 1569031870347,
            "createdAt": 1569031870347,
            "type": "DevOps",
            "count": 159,
            "description": "在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。",
            "activeUser": 196917,
            ...
            "href": "/",
            "updatedAt": 1569024670347,
            "createdAt": 1569024670347,
            "type": "GitOps",
            "count": 217,
            "description": "在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。",
            "activeUser": 117104,
            ...
            "href": "/",
            "updatedAt": 1569017470347,
            "createdAt": 1569017470347,
            "type": "Istio",
            "count": 275,
            "description": "在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。",
            "activeUser": 134234,
            ...
            "logo": "https://gw.alipayobjects.com/zos/rmsportal/zOsKZmFRdUtvpqCImOVY.png",
            "href": "/",
            "updatedAt": 1569010270347,
            "createdAt": 1569010270347,
            "type": "CI / CD",
            "count": 333,
            "description": "在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。",
            "activeUser": 108872,
            ...
            "logo": "https://gw.alipayobjects.com/zos/rmsportal/kZzEzemZyKLKFsojXItE.png",
            "href": "/",
            "updatedAt": 1569003070347,
            "createdAt": 1569003070347,
            "type": "k8s",
            "count": 391,
            "description": "在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。",
            "activeUser": 101296,
            ...
            "logo": "https://gw.alipayobjects.com/zos/rmsportal/siCrBXXhmvTQGWPNLBow.png",
            "href": "/",
            "updatedAt": 1568995870347,
            "createdAt": 1568995870347,
            "type": "DevOps",
            "count": 449,
            "description": "在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。",
            "activeUser": 144807,
